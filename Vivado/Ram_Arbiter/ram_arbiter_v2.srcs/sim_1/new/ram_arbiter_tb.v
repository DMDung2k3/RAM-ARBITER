...
RST_N <= 1; 
WR_EN_C1 <= 0; 
REQUEST_C2 <= 1; RD_WRITE_BAR_C2 <= 0; 
ADDR_C2 <= 4'b1110; 
INDATA_C2 <= 8'b11100011; #1700;  WR_EN_C1 <= 0; RD_WRITE_BAR_C2 <= 1; 
ADDR_C2 <= 4'b1110;
...
// Test Case 1: Only Client1 wants to write
//-----------------------------------------
// Test Case 9: Client2 wants to read and write in different RAM location at the same time
//--------------------------------------------------------------------------------------------
//RST_N = 1; // Reset is active low

//WR_EN_C1 = 0; // Client1 write is disabled
//RD_EN_C1 = 0; // Client1 read is disabled

//REQUEST_C2 = 1; // Client2 sends a request
//RD_WRITE_BAR_C2 = 0; // Client2 wants to write
//ADDR_C2 = 4'b1010; // Write address for Client2
//INDATA_C2 = 8'b11100011; // Write data for Client2
//#1700; // Wait for 1700 ns

//RD_WRITE_BAR_C2 = 0; // Client2 wants to write
//ADDR_C2 = 4'b1001; // Write address for Client2
//INDATA_C2 = 8'b00100011; // Write data for Client2
//RD_WRITE_BAR_C2 = 1; // Client2 read is enabled
//ADDR_C2 = 4'b1010; // Read address for Client2
// Test Case: Client2 wants to read and write in different RAM location at the same time
//--------------------------------------------------------------------------------------------
//RST_N = 1; // Reset is active low
...
//RD_WRITE_BAR_C2 = 0; // Client2 wants to write again
//ADDR_C2 = 4'b1010; // Write address for Client2
//INDATA_C2 = 8'b00100011; // Write data for Client2
	#500
	$finish;
