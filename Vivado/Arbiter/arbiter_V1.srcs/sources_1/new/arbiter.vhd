...
RD_ADDR_C1: in std_logic_vector(G_ADDR_WIDTH-1 downto 0);--read addr---
WR_ADDR_C1: in std_logic_vector(G_ADDR_WIDTH-1 downto 0);--write addr--
WR_DATA_C1: in std_logic_vector(G_DATA_WIDTH-1 downto 0);--data in----
---------------------------------------------------------------------------------------------------------------------
-- Inputs from --------client2--------------
---------------------------------------------------------------------------------------------------------------------
DATA_IN_C2: in std_logic_vector(G_DATA_WIDTH-1 downto 0);--input data--
...
--output from --------client1--------------
---------------------------------------------------------------------------------------------------------------------
RD_DATA_C1: out std_logic_vector(G_DATA_WIDTH-1 downto 0);--data out--
---------------------------------------------------------------------------------------------------------------------
--output from --------client2--------------
---------------------------------------------------------------------------------------------------------------------
DATA_OUT_C2: out std_logic_vector(G_DATA_WIDTH-1 downto 0);--out data--
ACK_C2: out std_logic; --acknowledgement--
---------------------------------------------------------------------------------------------------------------------
...
signal pr_client_read, nx_client_read, pr_client_write, nx_client_write: client;
...
TEMP_WR_EN <= WR_EN_C1;
TEMP_WR_DATA <= WR_DATA_C1;
TEMP_WR_ADDR <= WR_ADDR_C1;
elsif(nx_client_write=client2_write)then
if(TEMP_WR='0')then
TEMP_WR_EN <= '1';
TEMP_WR_ADDR <= ADDR_C2;
TEMP_WR_DATA <= DATA_IN_C2;
TEMP_WR <= '1';
...
---------------------------------------------------------------------------------------------------------------------
--------Data in output from temp registers---------
---------------------------------------------------------------------------------------------------------------------
RD_EN<= TEMP_RD_EN;
WR_EN<= TEMP_WR_EN;
...
---------------------------------------------------------------------------------------------------------------------
DATA_OUT_C2<=RD_DATA when (ADDR_CLASH='0') else
 TEMP_RD_DATA;

---------------------------------------------------------------------------------------------------------------------
-----------------------Data out for client 1-------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------
RD_DATA_C1<=RD_DATA when (REGISTERED_DATA =0 and ADDR_CLASH='0' ) else
